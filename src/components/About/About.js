      ...
      <div className="container about-page">
        <div className="text-zone">
          ...
          <p>
            ...
            technology, which led me to make a career transition from the
            military to becoming a general contractor and, ultimately, pursuing
            my dream as a web developer.
          </p>
          <p>
            I am thrilled about the opportunities in web development, and I
            believe my diverse background and relentless pursuit of perfection
            make me a valuable and dedicated asset for any employer.
          </p>
        </div>
